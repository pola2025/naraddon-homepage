  ...
  return (
    <div style={{ padding: '20px' }}>
      <div style={{ marginBottom: '20px', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
        <h1 style={{ fontSize: '24px', fontWeight: 'bold' }}>사업자 목소리 관리</h1>
        <button onClick={() => router.push('/business-voice')} style={{
          padding: '8px 16px',
          background: '#4CAF50',
          color: 'white',
          border: 'none',
      ...
      <div className="admin-content" style={{ background: 'transparent' }}>
